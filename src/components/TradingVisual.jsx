// Original trading-dashboard visual, recreated from scratch in Ai Nobiloption's
  ...
  return (
    <div className="tv-card">
      <div className="tv-head">
        <span className="tv-brand">Ai Nobiloption</span>
        ...
        <svg viewBox="0 0 560 212" role="img" aria-label="Upward trending automated trading chart">
          <defs>
            <linearGradient id="tvGrad" x1="0" y1="0" x2="0" y2="1">
              <stop offset="0" stopColor="#EAFF47" stopOpacity="0.32" />
              <stop offset="1" stopColor="#EAFF47" stopOpacity="0" />
            </linearGradient>
          </defs>
          <g fill="none" stroke="rgba(200,240,0,.14)" strokeDasharray="2 6">
            <path d="M0 40 H560" />
            <path d="M0 90 H560" />
            <path d="M0 140 H560" />
            <path d="M0 190 H560" />
