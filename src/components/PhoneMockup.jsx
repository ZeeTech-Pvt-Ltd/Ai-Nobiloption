...
// Built from scratch in Ai Nobiloption's brand colours; only the generic
          ...
          <svg className="pm-chart" viewBox="0 0 320 150" role="img" aria-label={`${v.label} trading chart`}>
            <defs>
              <linearGradient id={gid} x1="0" y1="0" x2="0" y2="1">
                <stop offset="0" stopColor="#EAFF47" stopOpacity="0.3" />
                <stop offset="1" stopColor="#EAFF47" stopOpacity="0" />
              </linearGradient>
            </defs>
            <g stroke="rgba(200,240,0,.12)" strokeDasharray="2 5">
              <path d="M0 38 H320" />
              <path d="M0 76 H320" />
              <path d="M0 114 H320" />
            </g>
