...
// is rewritten for Ai Nobiloption in its own words. Brand colors/fonts unchanged.
...
const sections = [
  {
    ...
    t: 'Introduction',
    p: [
      "Ai Nobiloption (\"we\", \"us\", \"our\") respects your privacy and treats personal information with transparency and integrity. This Privacy Notice explains what information we collect, how we use it, and the choices you have.",
    ],
  },
  {
    n: '02',
    ...
    <>
      ...
      <section className="terms-hero">
        <div className="container terms-hero-inner reveal">
          ...
          <p className="lead">How Ai Nobiloption collects, uses, and protects your personal information.</p>
