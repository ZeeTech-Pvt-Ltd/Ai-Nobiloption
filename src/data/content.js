...
export const nav = [
  ...
  { label: 'Reviews', href: '/ai-nobiloption-review-australia-scam' },
  { label: 'FAQ', href: '/faq' },
...
export const hero = {
  ...
  lead: 'Ai Nobiloption brings market tools, account management and automated trading features together in one place. Follow market activity, manage your account and make informed decisions with a platform designed to be simple to use.',
  checks: [
...
export const steps = [
  ...
  },
  {
    ...
    icon: 'chart',
    title: 'Start Trading',
    text: 'Let the automation trade hands-free, or steer the markets yourself, it is your call. When auto mode is on, Ai Nobiloption watches prices 24/7, places trades on your behalf, and keeps your balance current in real time.',
    cta: 'Get started',
  },
]
...
export const experience = {
  ...
  lead: [
    'Ai Nobiloption is an online trading platform designed to bring market tools and account management into one easy-to-use dashboard. Users can follow market activity, review available trading opportunities and manage their account from one place.',
  ...
  rows: [
    {
      ...
      imageAlt: 'Chart analysis view on the Ai Nobiloption platform',
      imageW: 1200, imageH: 800,
    },
    {
      ...
      imageAlt: 'Paper trading simulator with a virtual balance on the Ai Nobiloption platform',
      imageW: 1200, imageH: 800,
    },
    {
      ...
      imageAlt: 'Strategy builder view on the Ai Nobiloption platform',
      imageW: 1200, imageH: 800,
    },
    {
      ...
      imageAlt: 'Risk management dashboard on the Ai Nobiloption platform',
      imageW: 1200, imageH: 800,
    },
  ],
}
...
export const features = [
  ...
  },
  {
    ...
    text: 'Follow global markets without going it alone. Ai Nobiloption delivers sharp execution and live signals around the clock.',
  },
  {
    icon: 'shield', title: 'Serious Security, Total Peace of Mind',
    text: 'Industry-standard encryption and multi-factor authentication help keep every Ai Nobiloption account across Australia protected.',
  },
]
...
export const precision = [
  ...
  },
  {
    ...
    text: 'The Ai Nobiloption engine reads pricing, liquidity shifts, and volatility, then executes trades automatically at exactly the right moment.',
  },
  {
...
export const testimonials = {
  ...
  items: [
    {
      quote: "Using Ai Nobiloption has been a pleasure from day one. The automation responds quickly, and the dashboard makes it easy to follow everything as it happens.",
...
export const portfolio = {
  ...
  titleEnd: ' Trading',
  lead: 'Through the Ai Nobiloption platform, traders in Australia enjoy a clean, data-first experience, live performance tracking plus tools that are refreshingly simple to understand and use.',
  checks: [
  ...
  imageAlt: 'Manage your portfolio with data-driven trading on the Ai Nobiloption platform',
  imageW: 1200, imageH: 800,
}
...
export const faqPage = [
  {
    q: 'What does Ai Nobiloption actually do?',
    a: 'Ai Nobiloption uses AI-driven data analysis to process large volumes of market and industry data, surfacing patterns and generating structured recommendations. Our platform is designed to support decision-making for professionals and investors, not to replace independent judgement or professional advice.',
  },
  {
    q: 'Is Ai Nobiloption a financial advisory service?',
    a: 'No. Ai Nobiloption provides data-informed insights and analysis tools. Nothing produced by our platform constitutes personalised financial advice, a recommendation to buy or sell any asset, or a guarantee of any outcome. Users should consult a licensed advisor before making financial decisions.',
  },
  {
  ...
  {
    q: 'Who is Ai Nobiloption designed for?',
    a: 'Ai Nobiloption is built for professionals and investors who want a structured, data-first view of market activity. It suits users who are comfortable reviewing analytical output and applying their own judgement rather than expecting turnkey instructions.',
  },
  {
  ...
  {
    q: 'Does Ai Nobiloption guarantee accurate predictions?',
  ...
  {
    q: 'What kind of data does Ai Nobiloption analyse?',
...
export const faq = [
  {
    q: 'Is Ai Nobiloption Legit?',
    a: 'Yes. Ai Nobiloption is an AI-driven automated trading platform with a community score of 4.8 out of 5 based on 1,247 independent reviews. Every trade, signal, and performance figure is visible in real time, and traders across Australia use the platform daily for fast execution.',
  },
  {
    q: 'How Much Do I Need to Start Trading on Ai Nobiloption?',
  ...
  {
    q: 'How Secure Are My Money and Data on Ai Nobiloption?',
  ...
  {
    q: 'How Does Ai Nobiloption Maintain Transparency?',
  ...
  },
  {
    ...
    a: "Our platform's popularity has made it a target for bad actors who build lookalike (scam) sites to mislead visitors. Always double-check that you are on the official domain, ai-nobiloption.com.",
  },
]
...
export const footer = {
  blurb: 'Ai Nobiloption is an AI-driven automated trading platform for users in Australia, automated strategies, live market insight, and dependable security all in one place.',
  company: [
    { label: 'Home', href: '/' },
    { label: 'About Us', href: '/about' },
    { label: 'How It Works', href: '/how-it-works' },
